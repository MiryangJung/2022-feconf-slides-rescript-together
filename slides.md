...
존재하지 않는 걸 부를 수 없고, 타입 세이프티하게 개발을 할 수 있게 됩니다.
-->
...
하지만 안전한 타입 시스템 안에서 개발을 하는 경험을 꼭 해보셨으면 합니다.

불변성과 순수 함수를 지향하는 함수형 프로그래밍은 컨텍스트 없이도 코드 리뷰가 가능하고, 다른 사람의 코드를 읽는 것이 더 이상 괴로운 일이 되지 않게 됩니다.
